...
const holdToEarnCampaigns = [
  { name: 'Deposit WLD on Morpho', apy: '1.04', protocol: 'Morpho', participants: '2.4k', image: '/morpho.svg' },
  { name: 'Supply USDC on Aave', apy: '3.21', protocol: 'Aave', participants: '5.1k', image: '/aave.png' },
  { name: 'Stake ETH on Lido', apy: '0.85', protocol: 'Lido', participants: '1.8k', image: '/lido.jpg' },
];
    ...
    <div className="phone-frame">
      <div className="phone-screen">
        ...
        <div className="px-5 pt-4 pb-2">
          ...
          <p className="text-[32px] font-semibold text-black tracking-tight">$0.00</p>
        </div>
                ...
                <div className="bg-[#f0faf0] rounded-2xl border border-[#56B548]/10 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between px-3.5 py-2 bg-[#56B548]/5 border-t border-[#56B548]/10">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <ChevronRight className="w-3.5 h-3.5 text-[#3d8a34]" strokeWidth={2.5} />
                    </div>
                  </div>
                </div>
              </Link>
