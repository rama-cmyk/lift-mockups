...
const screens = [
  {
    href: '/explore-a-idle',
    label: 'Idle Explore',
    description: 'User is browsing campaigns they haven\'t joined yet. Discovery and opportunity.',
    color: '#a1a1aa',
  },
  {
    href: '/detail-a-idle',
    label: 'Idle Detail',
    description: 'Campaign detail before depositing. APY breakdown, how it works, and CTA to deposit.',
    color: '#a1a1aa',
  },
  {
    href: '/explore-a',
    label: 'Earning Explore',
    description: 'User is actively earning. Countdowns, progress, and deposit-more option on each card.',
    color: '#56B548',
  },
  {
    href: '/detail-c',
    label: 'Earning Detail',
    description: 'Campaign detail while earning. APY breakdown, progress, stepper, and claim button.',
    color: '#56B548',
  },
];
    ...
    <div className="min-h-screen bg-[#09090b] text-white p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-[#a1a1aa] text-base mb-8">
          Hold-to-Earn experience in the Lift miniapp. Two user states — idle (browsing) and earning (active) — across explore and detail screens.
        </p>
